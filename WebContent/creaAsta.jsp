...
<body>
	<div class="container">
		...
		<form method="POST" action="creaAsta">
			...
			Base d'asta <input type="number" size="40" maxlength="40"
				name="baseAsta" /><br /> Oggetto : <br> Nome oggetto <input
				type="text" size="40" maxlength="40" name="nomeOggetto" /><br />
			Descrizione <input type="text" size="40" maxlength="40"
				name="descrizione" /><br /> Categoria:
		...
		%>
			<br> <br> <input name="tipo" type="SUBMIT"
				value="Crea Asta a Superamento Immediato"> <input
				name="tipo" type="SUBMIT" value="Crea Asta a Busta Chiusa">
		</form>
	</div>
</body>
</html>