...
/**
 * Servlet implementation class creaAstaBustaChiusa
 */
@WebServlet("/creaAstaBustaChiusa")
public class creaAstaBustaChiusa extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public creaAstaBustaChiusa() {
        super();
